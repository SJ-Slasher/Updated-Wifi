      ...
      <div className="flex flex-col flex-1 overflow-hidden min-w-0">
        ...
        <header className="flex items-center gap-2 px-3 h-14 border-b border-border bg-card/80 backdrop-blur-md sticky top-0 z-10 flex-shrink-0">
          ...
          <button
            ...
            className="w-10 h-10 flex items-center justify-center rounded-xl border border-border bg-card/90 text-foreground shadow-sm hover:bg-card transition-colors flex-shrink-0"
            ...
            {!isAuthenticated && (
              <>
                <button
                  ...
                  className="flex sm:hidden items-center gap-1.5 text-xs font-medium px-3 py-2 rounded-lg bg-cyan-500 text-slate-950 hover:bg-cyan-400 transition-colors"
                >
                  <LogIn size={13} />
                  Sign In
                </button>
